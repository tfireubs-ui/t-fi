...
- **mcp-server targets:** PRs open: #304→#328 (reputation, CHANGES_REQUESTED fixes pushed, ping due 07:20 UTC), #190→#341 (ordinals marketplace, CHANGES_REQUESTED fixes pushed + CI green, ping due 07:20 UTC), #308→#344 (stacking lottery, APPROVED). Issues #300/#301 stale (tools exist in v1.37.0 — commented, needs maintainer close).
